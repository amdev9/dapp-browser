...
// IPFS Room
export const IPFS_ROOM_SUBSCRIBE = 'IPFS_ROOMS_SUBSCRIBE'
export const IPFS_ROOM_SUBSCRIBE_SUCCESS = 'IPFS_ROOMS_SUBSCRIBE_SUCCESS'
export const IPFS_ROOM_SUBSCRIBE_FAILURE = 'IPFS_ROOMS_SUBSCRIBE_FAILURE'
