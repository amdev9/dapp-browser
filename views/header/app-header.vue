                ...
                <div class="col navbar-user">
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-auto navbar-user-nav">
                            <b-dropdown :text="currentNet">
                                <b-dropdown-item-button @click.prevent="currentNet='Mainnet'">Mainnet</b-dropdown-item-button>
                                <b-dropdown-item-button @click.prevent="currentNet='Mynet'">Mynet</b-dropdown-item-button>
                                <b-dropdown-item-button @click.prevent="currentNet='Testnet'">Testnet</b-dropdown-item-button>
                            </b-dropdown>

                            <header-keys-selector/>
...
<script>
import headerKeysSelector from './header-keys-selector.vue';

export default {
	components: {
		'header-keys-selector': headerKeysSelector,
    },
    data () {
        return {
            search: false,
