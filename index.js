...
console.log('proc.spawn should execute: ' + electron + ' --enable-sandbox  ' + __dirname + "/electron/dist/main.js");
/*
...
*/
const child = proc.spawn(electron , ["--enable-sandbox", __dirname + "/electron/dist/main.js"])
